    ...
    <div class="flex items-center justify-center min-h-screen bg-blue-800">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            <div class="flex justify-center mb-6">
                <img src="{{ asset('images/pet_logo.jpg') }}" alt="Paw Care">
            </div>
            <div class="text-center text-2xl font-bold mb-6">Paw Care</div>
            <x-validation-errors class="mb-4" />

            <form method="POST" action="{{ route('admin.adminstore') }}">
                @csrf
                ...
                <div class="text-center">
                    <span>Already have an account?</span><a href="{{ route('adminlogin') }}" class="text-blue-600">Sign In</a>
                </div>
            </form>
        </div>
    </div>
