...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{ asset('import/vendors/ti-icons/css/themify-icons.css') }}">
  <link rel="stylesheet" href="{{ asset('import/vendors/base/vendor.bundle.base.css') }}">
  <!-- endinject -->
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="{{ asset('import/images/favicon.png') }}">
</head>
<body>
  ...
  <!-- plugins:js -->
  <script src="{{ asset('import/vendors/base/vendor.bundle.base.js') }}"></script>
  <!-- endinject -->
  <!-- inject:js -->
  <script src="{{ asset('import/js/off-canvas.js') }}"></script>
  <script src="{{ asset('import/js/hoverable-collapse.js') }}"></script>
  <script src="{{ asset('import/js/template.js') }}"></script>
  <script src="{{ asset('import/js/todolist.js') }}"></script>
  <!-- endinject -->
