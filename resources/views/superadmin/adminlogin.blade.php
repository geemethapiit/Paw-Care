    ...
    <div class="flex items-center justify-center min-h-screen bg-blue-800">
        <div class="bg-white p-8 rounded-lg shadow-lg w-3/4 md:w-1/2 lg:w-1/3">
            <div class="flex justify-center mb-6">
                <img src="{{ asset('images/pet_logo.jpg') }}" alt="Sky Pet Animal Hospital">
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="text-center">
                    <span>Don't You have an account? </span><a href="{{ route('adminregister') }}" class="text-blue-600">Register</a>
                </div>
            </form>
        </div>
    </div>
